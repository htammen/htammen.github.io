sap.ui.define([
	...
	return Controller.extend("de.tammenit.ui5.homepage.controller.SharedBlocks.BaseBlockController", {
		formatLabel: function (rating) {
			...
			// TODO: Hier stimmt etwas nicht. Wenn der der auskommentierte Code ausgeführt wird, gibt es eine Exception und es wird komisch gerendered
			var type = undefined // = model.getProperty(this.getView().getBindingContext().getPath() + "/Type");
