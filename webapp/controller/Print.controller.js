            ...
            function(obj) {
              var ret = {
                text: [
                  ...
                  { text: this.getCurrentLangValue(obj.Text) + ", " },
                  { text: obj.Title + ", " },
                  { text: obj.Location }
                ]
              };
              ...
              tmpArr = obj.items.map(
                function(project) {
                  ...
                  ret.push([
                    {
                      text:
                        this.getCurrentLangValue(project.Start) +
                        " - " +
                        this.getCurrentLangValue(project.End),
                      style: "headerProject"
                    },
                  ...
                  ret.push([
                    {
                      text: this.getCurrentLangValue(project.Branch),
                      style: "headerProject"
                    },
                    {
                      text: this.getCurrentLangValue(project.Header),
                      style: "subHeaderProject"
                    },
                    { text: this.getCurrentLangValue(project.Longtext) },
                    {
                      text: this.getCurrentLangValue(project.Tools),
                      style: "projectTools"
                    }
                  ]);
                  return ret;
            ...
            table: {
              ...
              body: [
                [
                  ...
                  {
                    text: i18n.getProperty("consultant_profile"),
                    style: "headermiddle"
                  },
                  {
                    image: imgURL,
            ...
            },
            {
              table: {
                ...
                body: [
                  ...
                  [
                    { text: "Presentations: ", style: "columnLeft" },
                    createPresentations.bind(this)()
                  ],
                  [
                    { text: "", style: "columnLeft" },
                    { text: "", style: "columnLeft" }
